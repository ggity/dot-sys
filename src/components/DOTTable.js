                ...
                <TableRow>
                  ...
                  <TableCell>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                      <CalendarMonthIcon />
                      <Typography variant="p" fontWeight="bold">
                        {dayjs(record.dotDate).format("MM.DD.YYYY")}
                      </Typography>
                    </Stack>
                  </TableCell>
                  <TableCell>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                      ...
                      <Typography variant="p" fontWeight="bold">
                        {dayjs(Date.now()).subtract(7, "d").format("MM.DD")}-{" "}
                        {dayjs(record.dotDate).format("MM.DD")}
                      </Typography>
                    </Stack>
                  </TableCell>
                  <TableCell>
                    <Stack direction="row" spacing={0.5} alignItems="center">
                      ...
                      <Typography variant="p" fontWeight="bold">
                        {dayjs(record.dotDate).format("MM.DD")} - Today
                      </Typography>
                    </Stack>
                  </TableCell>
                </TableRow>
